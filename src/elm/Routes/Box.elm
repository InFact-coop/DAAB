        ...
        section [ class "custom-padding" ]
            [ Html.form []
                ...
                , div [ class "dib v-top ml3" ]
                    ...
                    , br [] []
                    , input [ id "boxno1", class "w2 f4", type_ "text", maxlength 2, onInput UpdateBoxNo1 ] []
                    , partition
                    , input [ id "boxno2", class "w2 f4", type_ "text", maxlength 2, onInput UpdateBoxNo2 ] []
                    , partition
                    , input [ id "boxno3", class "w2 f4", type_ "text", maxlength 2, onInput UpdateBoxNo3 ] []
                    ]
                , div [ class "mt4" ]
                    [ p [ class "f4" ]
                        [ text "Please select which of these applies:" ]
                    , div [ class "lh-copy" ]
                        [ input [ type_ "radio", class "mt3", name "nbsc", id "n", onClick (UpdateBoxOutletStatus New) ] []
                        , label [ class "ml3", for "n" ] [ text "New Outlet" ]
                        ]
                    , div [ class "lh-copy" ]
                        [ input [ type_ "radio", class "mt3", name "nbsc", id "b", onClick (UpdateBoxOutletStatus Broken) ] []
                        , label [ class "ml3", for "b" ] [ text "Seal Broken" ]
                        ]
                    , div [ class "lh-copy" ]
                        [ input [ type_ "radio", class "mt3", name "nbsc", id "s", onClick (UpdateBoxOutletStatus Stolen) ] []
                        , label [ class "ml3", for "s" ] [ text "Box Stolen and Replaced" ]
                        ]
                    , div [ class "lh-copy" ]
                        [ input [ type_ "radio", class "mt3", name "nbsc", id "c", onClick (UpdateBoxOutletStatus Closed) ] []
